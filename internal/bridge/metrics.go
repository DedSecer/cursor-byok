...
func (service *MetricsService) GetHomeMetricsSummary() (HomeMetricsSummary, error) {
	...
	return HomeMetricsSummary{
		...
		CacheObservedCalls:       summary.CacheObservedCalls,
		CacheObservedInputTokens: summary.CacheObservedInputTokens,
		CacheObservedReadTokens:  summary.CacheObservedReadTokens,
		CacheObservedWriteTokens: summary.CacheObservedWriteTokens,
		CacheObservationPartial:  summary.CacheObservationPartial,
